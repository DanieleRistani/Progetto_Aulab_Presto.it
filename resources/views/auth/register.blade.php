<x-layouts.app title="{{__('ui.register')}}">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="input-group mb-3 ms-3">
                            ...
                            <input type="text" name='name'
                                class="form-control-lg login_input border-start-0 @error('name') is-invalid @enderror" placeholder="{{__('ui.nome')}}"
                        ...
                        <div class="ms-3">
                            <p class="mb-0 font_custom text-sec">{{__('ui.haiaccount')}}
                                <a href="{{ route('login') }}"class="text-blackcus  fw-bold font_custom">{{__('ui.loginbtn')}}</a>
                            </p>
                        </div>


                        <div class="d-flex justify-content-center me-2">
                            <button class="btn bg-sec btn-lg px-5 text-white text-uppercase fw-bold mt-5 btn-custom-sec" type="submit">{{__('ui.registrati')}}</button>
                        </div>
                    </form>
                </div>
